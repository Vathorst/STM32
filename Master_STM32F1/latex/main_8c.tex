...
\begin{DoxyCompactList}\small\item\em Checks if the screen sent a message. Also checks if a manual pin has been pulled down. Will activate the mastermodule\textquotesingle{}s protocol. \end{DoxyCompactList}\item 
...
Checks if the screen sent a message. Also checks if a manual pin has been pulled down. Will activate the mastermodule\textquotesingle{}s protocol. 
